document.addEventListener("DOMContentLoaded", function () {
    ...
    const images = [
        { src: "./Stills/photo1.jpg", description: "Sunset Over Mountain, APU" },
        { src: "./Stills/photo2.jpg", description: "City Lights at Night, APU" },
        { src: "./Stills/photo3.jpg", description: "Waves Crashing on Shore, APU" }
    ];
